...
<head>
    ...
    <title>Edit Kampus - TOEICLY Admin</title>
    <!-- Tailwind CSS -->
...
<body>
    ...
    <main>
        <h1 class="text-4xl font-bold mb-6 text-purple-700">Edit Kampus</h1>
        ...
        <form action="{{ route('kampus.update', $kampus->kampus_id) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')

            <div>
                <label for="kampus_kode">Kode Kampus</label>
                <input type="text" id="kampus_kode" name="kampus_kode" maxlength="10" required
                    value="{{ old('kampus_kode', $kampus->kampus_kode) }}">
            </div>
            <div>
                <label for="kampus_nama">Nama Kampus</label>
                <input type="text" id="kampus_nama" name="kampus_nama" maxlength="50" required
                    value="{{ old('kampus_nama', $kampus->kampus_nama) }}">
            </div>
