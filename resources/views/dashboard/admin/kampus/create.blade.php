...
<head>
    ...
    <title>Tambah Kampus - TOEICLY Admin</title>
    <!-- Tailwind CSS -->
...
<body>
    ...
    <main>
        <h1 class="text-4xl font-bold mb-6 text-purple-700">Tambah Kampus</h1>
        ...
        <form action="{{ route('kampus.store') }}" method="POST" class="space-y-6">
            @csrf
            <div>
                <label for="kampus_kode">Kode Kampus</label>
                <input type="text" id="kampus_kode" name="kampus_kode" maxlength="10" required value="{{ old('kampus_kode') }}">
            </div>
            <div>
