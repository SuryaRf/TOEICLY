...
<head>
    ...
    <title>Upload Jadwal Sertifikat - TOEICLY Admin</title>
    <!-- Tailwind CSS -->
...
<body>
    ...
    <main>
        ...
        <form action="{{ route('jadwal_sertifikat.store') }}" method="POST" enctype="multipart/form-data"
            class="space-y-6">
            @csrf
            <div>
            ...
            <div>
                <label for="tanggal" class="block mb-2 font-semibold">Tanggal Jadwal</label>
