    ...
    <aside class="sidebar">
        ...
        <nav>
            ...
            <form id="logout-form" action="{{ route('logout') }}" method="POST" style="margin-top: auto;">
                @csrf
                <button type="submit" style="all: unset; cursor:pointer; display:flex; align-items:center; padding: 0.75rem 1rem; font-weight:600; border-radius: 0.5rem; color:white; width: 100%;" onmouseover="this.style.backgroundColor='rgba(255 255 255 / 0.25)'" onmouseout="this.style.backgroundColor='transparent'">
